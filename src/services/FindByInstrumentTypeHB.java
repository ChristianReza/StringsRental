...
@WebServlet("/FindByInstrumentType")
public class FindByInstrumentTypeHB extends HttpServlet implements Info {
   private static final long serialVersionUID = 1L;

   public FindByInstrumentTypeHB() {
      super();
   }

   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      String keyword = request.getParameter("instrumentType").trim();
      ...
      if (keyword != null && !keyword.isEmpty()) {
         listStudents = UtilDBReza.FindByInstrumentType(keyword);
      } else {
